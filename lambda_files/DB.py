...
from datetime import datetime, timedelta # 파이썬 기본 라이브러리
...
class Repo(object):
    def __init__(self):
        self.engine = create_engine(
            ...
            "mysql+pymysql://root:1232123a-@crawl-database.cfdkhugbyfzl.ap-northeast-2.rds.amazonaws.com:3306/new_schema?charset=utf8mb4",
            echo=True,
            future=True,
        )
